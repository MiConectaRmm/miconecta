...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  tecnico_senior: ['devices:read', 'devices:write', 'devices:remote_access', 'tickets:*', 'chat:*', 'scripts:*', 'reports:read', 'audit:read', 'sessions:*', 'alerts:*'],
  tecnico: ['devices:read', 'devices:remote_access', 'tickets:read', 'tickets:write', 'chat:*', 'scripts:execute', 'alerts:read', 'alerts:acknowledge', 'sessions:initiate'],
  visualizador: ['devices:read', 'tickets:read', 'alerts:read', 'reports:read'],
  admin_cliente: ['devices:read', 'tickets:*', 'chat:*', 'reports:read', 'users:read', 'users:write', 'users:invite'],
  gestor: ['devices:read', 'tickets:read', 'tickets:write', 'chat:*', 'reports:read'],
